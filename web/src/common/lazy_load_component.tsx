...
export function lazyPage<T extends ComponentType<any>>(load: () => Promise<T>): ComponentType<any>;
export function lazyPage<T extends ComponentType<any>, Mod extends {}>(
  load: () => Promise<Mod>,
  pick: (mod: Mod) => T,
): ComponentType<any>;
export function lazyPage(load: () => Promise<any>, pick?: (mod: any) => any): ComponentType<any>;
export function lazyPage(load: () => Promise<any>, pick?: (mod: any) => any): ComponentType<any> {
