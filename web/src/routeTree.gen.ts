...
import { Route as SchoolUserUserIdPostChar123GroupIdChar125RouteImport } from './routes/_school/user/$userId/post/{-$groupId}.tsx'
...
const SchoolUserUserIdPostChar123GroupIdChar125Route =
  SchoolUserUserIdPostChar123GroupIdChar125RouteImport.update({
    id: '/post/{-$groupId}',
    path: '/post/{-$groupId}',
...
export interface FileRoutesByFullPath {
  ...
  '/user/$userId/post/{-$groupId}': typeof SchoolUserUserIdPostChar123GroupIdChar125Route
...
export interface FileRoutesById {
  ...
  '/_school/user/$userId/post/{-$groupId}': typeof SchoolUserUserIdPostChar123GroupIdChar125Route
...
export interface FileRouteTypes {
  ...
  id:
    ...
    | '/_school/review/$type/'
    | '/_school/user/$userId/post/{-$groupId}'
    | '/_school/wall/list/{-$groupId}/'
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/_school/user/$userId/post/{-$groupId}': {
      id: '/_school/user/$userId/post/{-$groupId}'
      path: '/post/{-$groupId}'
      fullPath: '/user/$userId/post/{-$groupId}'
      preLoaderRoute: typeof SchoolUserUserIdPostChar123GroupIdChar125RouteImport
...
interface SchoolUserUserIdRouteRouteChildren {
  SchoolUserUserIdPostChar123GroupIdChar125Route: typeof SchoolUserUserIdPostChar123GroupIdChar125Route
}

const SchoolUserUserIdRouteRouteChildren: SchoolUserUserIdRouteRouteChildren = {
  SchoolUserUserIdPostChar123GroupIdChar125Route:
    SchoolUserUserIdPostChar123GroupIdChar125Route,
}
