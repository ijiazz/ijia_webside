...
let camera: PerspectiveCamera, scene: Scene, renderer: CSS3DRenderer;
let controls: TrackballControls;

const objects: Object3D[] = [];
const targets: { table: Object3D[]; sphere: Object3D[]; helix: Object3D[]; grid: Object3D[] } = {
  table: [],
  sphere: [],
  helix: [],
  grid: [],
...
function init() {
  ...
  for (let y = 0; y < height; y++) {
    ...
    objectCSS.position.y = y * -(avatarWidth + gap);
  ...
  const buttonTable = document.getElementById("table") as HTMLButtonElement;
